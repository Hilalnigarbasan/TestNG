...
public class ExcelUtils {
    ...
    public ExcelUtils(String path, String sheetName) {
        ...
        // Constructor : Excel path i ve sayfaya ulasmak icn kullinir. Path in doğru olup olmadığını anlarız
        this.path = path;
        try {
    ...
    //Excel deki verileri List olarak almamızı sağlar
    //Excel deki verileri Test sınıfında kullanmak için bu methodu kullanıcaz
    ...
    // Excel deki toplam sütun sayısını return eder
    ...
    // Excel deki toplam satır sayısını return eder
    public int rowCount() {
    ...
    // Exceldeki datalari 2 boyutlu array seklinde alir. Başlık dahil
